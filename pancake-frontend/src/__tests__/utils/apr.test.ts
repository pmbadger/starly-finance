...
jest.mock('../../config/constants/lpAprs.json', () => ({
  '0x110B11C4C08fE1E282B7Cd17ebDFc1Ce18d630Cf': 10.5,
}))
...
describe('getFarmApr', () => {
  ...
  it(`get the correct pool APR`, () => {
    ...
    expect(cakeRewardsApr).toEqual(220752)
    expect(lpRewardsApr).toEqual(0)
  })
  it(`get the correct pool APR combined with LP APR`, () => {
    const { cakeRewardsApr, lpRewardsApr } = getFarmApr(
      ...
      '0x110B11C4C08fE1E282B7Cd17ebDFc1Ce18d630Cf',
    )
    expect(cakeRewardsApr).toEqual(220752)
