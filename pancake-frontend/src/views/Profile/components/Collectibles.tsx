  ...
  return (
    <>
      <Heading as="h4" scale="md" mb="8px">
        {t('Starly Collectibles')}
      </Heading>
      <Text as="p">{t('Starly Collectibles are special ERC-721 NFTs that can be used on the Starly platform.')}</Text>
      <Text as="p">
        {t('NFTs in this user’s wallet that aren’t approved Starly Collectibles won’t be shown here.')}
      </Text>
      ...
      <Flex alignItems="center" justifyContent="flex-end">
        <Link to="/collectibles">{t('See all approved Starly Collectibles')}</Link>
        <ChevronRightIcon />
      </Flex>
    </>
  )
