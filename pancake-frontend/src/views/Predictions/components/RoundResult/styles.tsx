...
import { formatUsdv2, formatEthv2 } from '../../helpers'
import { formatEth, formatUsd } from '../History/helpers'
...
const getPrizePoolAmount = (totalAmount: PrizePoolRowProps['totalAmount']) => {
  ...
  return formatEthv2(totalAmount)
}
  ...
  return (
    <Row height="18px" {...props}>
      ...
      <Flex alignItems="center">
        ...
        <Text mx="4px">|</Text>
        <Text fontSize="12px" lineHeight="18px">{`${formatEth(amount)} ETH`}</Text>
      </Flex>
    </Row>
  )
}
