...
const EarningsCell: React.FC<EarningsCellProps> = ({ pool, account, userDataLoaded }) => {
  ...
  // These will be reassigned later if its Auto STLY vault
  ...
  const labelText = isAutoVault ? t('Recent STLY profit') : t('%asset% Earned', { asset: earningToken.symbol })
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <>
      <Balance fontSize="16px" value={autoCakeToDisplay} decimals={3} bold unit=" STLY" />
