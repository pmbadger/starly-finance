...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'STLY card' },
    { src: 'green', alt: 'Green STLY card with up arrow' },
    { src: 'red', alt: 'Red Stly card with down arrow' },
    { src: 'top-right', alt: 'STLY card' },
  ],
}
