  ...
  return (
    <ModalInner mb="0">
      <Text as="p" mb="24px" fontSize="14px" color="textSubtle">
        {t(
          'Your voting power is determined by the amount of STLY you held at the block detailed below. STLY held in other places does not contribute to your voting power.',
        )}
      </Text>
      ...
      <Flex alignItems="center" justifyContent="space-between" mb="4px">
        ...
        <Text textAlign="right">{cakeEthLpBalance.toFormat(3)}</Text>
      </Flex>
    </ModalInner>
  )
}
