...
const Icon: React.FC<SvgProps> = (props) => {
  return (
    <Svg viewBox="-80 -72 256 256" {...props}>
      ...
      <circle cx="0" cy="0" r="6" fill="#1fc7d4" fillOpacity="1">
      ...
      <circle cx="0" cy="0" r="6" fill="#1fc7d4" fillOpacity="0.875">
      ...
      <circle cx="0" cy="0" r="6" fill="#1fc7d4" fillOpacity="0.75">
      ...
      <circle cx="0" cy="0" r="6" fill="#1fc7d4" fillOpacity="0.625">
      ...
      <circle cx="0" cy="0" r="6" fill="#1fc7d4" fillOpacity="0.5">
      ...
      <circle cx="0" cy="0" r="6" fill="#1fc7d4" fillOpacity="0.375">
      ...
      <circle cx="0" cy="0" r="6" fill="#1fc7d4" fillOpacity="0.25">
      ...
      <circle cx="0" cy="0" r="6" fill="#1fc7d4" fillOpacity="0.125">
